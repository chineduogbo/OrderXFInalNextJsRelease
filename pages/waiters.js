...
const Event = (props) => {
    ...
    return (
        <>
            <div className="" style={{ backgroundColor: "#f2f7ff" }}>
                <Dashboard title="Waiters">
                    <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <div className='table-responsive'>
                                    <Table dataSource={props.events}>
                                        ...
                                        <Column title="Waiter Username" dataIndex="WaiterUsername" key="WaiterUsername" />
...
export async function getStaticProps() {
    ...
    var data = await fetch('https://orderxc.herokuapp.com/Waiter/GetAll?EventId=622cfe3c93b06012790eb94f', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        }
